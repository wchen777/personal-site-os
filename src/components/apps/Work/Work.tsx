...
const workList = [
...

  {
    ...
    description: (
      <>
        ...
        <p class={css.cardText}>Fall 2022 - Computer Systems</p>
      </>
    ),
  },

  {
    ...
    description: (
      <p class={css.cardText}>
        I helped develop and release a forums page and 200+ notifications, fixed bugs and refactored
        business logic, and worked on reskinning the web and mobile UI.
      </p>
    ),
  },
